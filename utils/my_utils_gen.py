...
class MMGeneration:
    def __init__(self, 
        ...
        self.backbonedict = {
            ...
            "SinGAN": './utils/models/SinGAN/SinGAN.py',
        }
    ...
    def inference(self,
        ...
        sigan = "utils/models/SinGAN/singan_balloons.pth"
        print("========= begin inference ==========")
        self.save_path = save_path
        checkpoint = self.checkpoint
        checkpoint = 'utils/models/SinGAN/singan_balloons_20210406_191047-8fcd94cf.pth'
        if is_trained:
            # 加载数据集及配置文件的路径
