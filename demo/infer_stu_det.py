...
def normal_train_demo():
	...
	model.inference(is_trained=True, pretrain_model = '../checkpoints/det_plate/latest.pth', infer_data='../dataset/coco/images/test/0000.jpg', rpn_threshold=0.5, rcnn_threshold=0.3)
